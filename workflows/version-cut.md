...
| Bump | Means |
|---|---|
| **Major** (`1.0.0` → `2.0.0`) | The product is for a different user, or does a fundamentally different thing |
| **Minor** (`0.4.0` → `0.5.0`) | A coherent set of capability landed. This is the normal cut. |
| **Patch** (`0.4.0` → `0.4.1`) | Fixes and polish only, no new capability |
